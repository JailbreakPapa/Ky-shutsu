...
macro(ns_pull_platform_vars)
	...
	get_property(NS_CMAKE_PLATFORM_SUPPORTS_WEBGPU GLOBAL PROPERTY NS_CMAKE_PLATFORM_SUPPORTS_WEBGPU)
...
# #####################################
# ## ns_get_version(<VERSIONFILE> <OUT_MAJOR> <OUT_MINOR> <OUT_PATCH> <OUT_BUILD>)
# #####################################
function(ns_get_version VERSIONFILE OUT_MAJOR OUT_MINOR OUT_PATCH OUT_BUILD)
    ...
    # Match and extract the version components
    if(VERSION_STRING MATCHES "^([0-9]+)\\.([0-9]+)\\.([0-9]+)\\.([0-9]+)$")
        # Extract components using REGEX REPLACE
...
function(ns_detect_version)
	...
	ns_get_version("${NS_ROOT}/version.txt" VERSION_MAJOR VERSION_MINOR VERSION_PATCH VERSION_BUILD)
	...
	set_property(GLOBAL PROPERTY NS_CMAKE_SDKVERSION_BUILD "${VERSION_BUILD}")

	message(STATUS "SDK version: Major = '${VERSION_MAJOR}', Minor = '${VERSION_MINOR}', BuildIndex(Release) = '${VERSION_BUILD}', Patch = '${VERSION_PATCH}'")
endfunction()
...
macro(ns_pull_version)
	...
	get_property(NS_CMAKE_SDKVERSION_BUILD GLOBAL PROPERTY NS_CMAKE_SDKVERSION_BUILD)
endmacro()