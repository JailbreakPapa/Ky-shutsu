...
function(ns_set_build_flags_clang TARGET_NAME)
	...
	if(COMMAND ns_platformhook_set_build_flags_clang)
		...
		ns_platformhook_set_build_flags_clang(${TARGET_NAME})
	endif()
endfunction()
...
function(ns_set_build_flags TARGET_NAME)
	...
	# NOTE(Mikael A.): Bumping the standard to C++17. This is the default for all projects.
