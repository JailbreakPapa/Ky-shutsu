...
function(ns_export_target_dx12 TARGET_NAME)
    ...
    set(NS_D3D12_RESOURCES ${CMAKE_BINARY_DIR})
	...
	PRE_BUILD
	COMMAND ${CMAKE_COMMAND} -E copy_if_different ${NS_D3D12_AGILITY_SDK_PACKAGE_PATH}/bin/x64/D3D12Core.dll $<TARGET_FILE_DIR:${PROJECT_NAME}>
    COMMAND ${CMAKE_COMMAND} -E copy_if_different ${NS_D3D12_AGILITY_SDK_PACKAGE_PATH}/bin/x64/d3d12SDKLayers.dll $<TARGET_FILE_DIR:${PROJECT_NAME}>
	WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
    )
