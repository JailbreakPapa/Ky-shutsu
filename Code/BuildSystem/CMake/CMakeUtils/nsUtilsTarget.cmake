...
macro(ns_create_target TYPE TARGET_NAME)
	...
	set(ARG_OPTIONS NO_PCH NO_UNITY NO_QT NO_NS_PREFIX ENABLE_RTTI NO_WARNINGS_AS_ERRORS NO_COMPLIANCE ALL_SYMBOLS_VISIBLE NO_DEBUG NO_EXPORT)
	...
	if((${TYPE} STREQUAL "LIBRARY") OR(${TYPE} STREQUAL "STATIC_LIBRARY") OR(${TYPE} STREQUAL "SHARED_LIBRARY"))
		...
		if(COMMAND ns_platformhook_set_library_properties)
			ns_platformhook_set_library_properties(${TARGET_NAME})
		endif()
	...
	if(NS_APUI_FOUNDATION_AUTO_THREAD_COUNT)
		target_compile_definitions(${TARGET_NAME} PRIVATE NS_FOUNDATION_AUTO_THREAD_COUNT=NS_ON)
	else()
		target_compile_definitions(${TARGET_NAME} PRIVATE NS_FOUNDATION_AUTO_THREAD_COUNT=NS_OFF)
	endif()
	...
	if (EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/Platform/${NS_CMAKE_PLATFORM_POSTFIX}")
		target_include_directories(${TARGET_NAME} PUBLIC "${CMAKE_CURRENT_SOURCE_DIR}/Platform/${NS_CMAKE_PLATFORM_POSTFIX}")
	endif()
