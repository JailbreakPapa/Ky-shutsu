...
public:
  ...
  using nsDataDirFactory = nsDataDirectoryType* (*)(nsStringView, nsStringView, nsStringView, nsDataDirUsage);
  ...
  static nsResult AddDataDirectory(nsStringView sDataDirectory, nsStringView sGroup = {}, nsStringView sRootName = {}, nsDataDirUsage usage = nsDataDirUsage::ReadOnly); // [tested]
  ...
  static const nsDataDirectoryInfo* FindDataDirectoryWithRoot(nsStringView sRootName);
  ...
  static const nsDataDirectoryInfo& GetDataDirectoryInfo(nsUInt32 uiDataDirIndex);
...
public:
  ...
  static nsResult ResolvePath(nsStringView sPath, nsStringBuilder* out_pAbsolutePath, nsStringBuilder* out_pDataDirRelativePath, const nsDataDirectoryInfo** out_pDataDir = nullptr); // [tested]
...
private:
  ...
  struct FileSystemData
  {
    ...
    nsHybridArray<nsDataDirectoryInfo, 16> m_DataDirectories;
  ...
  static nsDataDirectoryInfo* GetDataDirForRoot(const nsString& sRoot);
